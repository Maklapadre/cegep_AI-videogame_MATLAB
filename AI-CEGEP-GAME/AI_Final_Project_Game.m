...
function varargout = AI_Final_Project_Game(varargin)
...
% Last Modified by GUIDE v2.5 11-May-2021 14:31:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AI_Final_Project_Game_OpeningFcn, ...
                   'gui_OutputFcn',  @AI_Final_Project_Game_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function AI_Final_Project_Game_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for AI_Final_Project_Game
...
% UIWAIT makes AI_Final_Project_Game wait for user response (see UIRESUME)
...
axes(handles.axes9)         
imshow(imread('background_farm.jpg'));                  
...
function varargout = AI_Final_Project_Game_OutputFcn(hObject, eventdata, handles) 
...
%                             
                        case 2      %if there are 2 lives left. After you dropped the egg once.
                            ...
                            if  handles.axes8.GridLineStyle == '-'
                                axes(handles.axes8)
                                egg_creator(0.08, 0.45, 1)  %blue coloring
            ...
            axes(handles.axes5)
            egg_creator(0.08, 0.45, 1)    %calling the same function as earlier, making the last life egg a blue shadow
