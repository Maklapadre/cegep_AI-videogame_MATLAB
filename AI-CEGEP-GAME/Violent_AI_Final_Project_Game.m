...
function varargout = Violent_AI_Final_Project_Game(varargin)
...
% Last Modified by GUIDE v2.5 11-May-2021 14:28:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Violent_AI_Final_Project_Game_OpeningFcn, ...
                   'gui_OutputFcn',  @Violent_AI_Final_Project_Game_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Violent_AI_Final_Project_Game is made visible.
function Violent_AI_Final_Project_Game_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Violent_AI_Final_Project_Game (see VARARGIN)

% Choose default command line output for Violent_AI_Final_Project_Game
...
% UIWAIT makes Violent_AI_Final_Project_Game wait for user response (see UIRESUME)
...
axes(handles.axes9)         
imshow(imread('hell_background.jpg'));                  
...
function varargout = Violent_AI_Final_Project_Game_OutputFcn(hObject, eventdata, handles) 
...
%Pause?
                    ...
                    switch handles.lives
                        case 2      %if there are 2 lives left. After you dropped the egg once.
                            ...
                            if  handles.axes8.GridLineStyle == '-'
                                axes(handles.axes8)
                                egg_creator(0.71, 0.31, 0.01)  %red/brown coloring
            ...
            axes(handles.axes5)
            egg_creator(0.71, 0.31, 0.01) %calling the same function as earlier, making the last life egg a red/brown shadow
